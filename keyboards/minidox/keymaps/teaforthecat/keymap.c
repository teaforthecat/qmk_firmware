 ...
 * `----------------------------------'           `----------------------------------'
 *                  ,-----------------------.    ,---------------------.
 *                 | tab   | bckspc  | ecs  |    | enter  | space| dead |
 *                 | shift | ctrl    | gui  |    | alt    |   fn |      |
 *                 `-------+---------+      |    |        |------+-------.
 *                                   `------'    `--------'
 */
  [_WM] = LAYOUT( \
    ...
    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,        KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, \
                    KC_SHTB, KC_BSCM, KC_CTES,      KC_ENOP, KC_SPFN, DK_ACT            \
  ),
 ...
 */
  [_DK] = LAYOUT( \
    ...
    KC_PERC, KC_CIRC,KC_LBRC, KC_RBRC, KC_TILDE,     KC_AMPR, KC_1, KC_2, KC_3, KC_BSLS, \
                     KC_SHTB, KC_BSCM , KC_CENT,     KC_CTES, KC_COMS, DK_REL                    \
  ),

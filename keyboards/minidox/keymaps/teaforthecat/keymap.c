...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT( \
               ...
               LM(3,MOD_LGUI), KC_ESC, CTL_T(KC_BSPC),  ALT_T(KC_SPC), KC_ENTER, LT(2,KC_MINUS) \
                ),
  ...
  [1] = LAYOUT( \
               ...
               KC_PERC, KC_CIRC,KC_LBRC, KC_RBRC, KC_TILDE,     _______, KC_MINUS, KC_UNDS, KC_BSLS, KC_SLSH, \
   ...
   */
  [2] = LAYOUT( \
               _______, _______, _______, _______, KC_HOME,     KC_PGUP, S(KC_TAB), KC_UP,   KC_TAB, _______, \
               _______, _______, _______, _______, KC_END,      KC_PGDN, KC_LEFT,   KC_DOWN, KC_RGHT, _______, \
